    ...
    const init = async () => {
      ...
      viewRef.current = new EditorView({
        ...
        extensions: [
          ...
          EditorView.theme({
            '&': { maxHeight: '320px' },
            '.cm-scroller': { fontFamily: 'var(--font-mono), monospace', fontSize: '13px', lineHeight: 1.5 },
    ...
    <div style={{ marginTop: 12 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <button
          onClick={toggleOpen}
          aria-expanded={open}
          style={{ fontSize: 13, fontWeight: 500, color: 'var(--color-accent)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
        >
